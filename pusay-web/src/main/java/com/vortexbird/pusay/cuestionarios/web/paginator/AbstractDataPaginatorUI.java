 ...
 * @class AbstractDataPaginatorUI
 * @date 12/07/2013
 *
 */
public abstract class AbstractDataPaginatorUI<T> extends AbstractBaseMessageUI {

	// DataModel bound to dataTable
	protected PagedListDataModel<T> dataModel;

	protected List<SelectItem> listPageSize;
	 ...
	 */
	public void setListPageSize(List<SelectItem> listPageSize) {
