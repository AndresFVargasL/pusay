 ...
 * deemed invalid, an {@link Exception} is thrown (typically).
 * For example:
 * 
 * <pre class="code">
...
public abstract class Assert {
	 ...
	 * <code>Exception</code> if the test result is
	 * <code>false</code>.
	 * 
	 * <pre class="code">
	 * Assert.isTrue(i &gt; 0, &quot;The value must be greater than zero&quot;);
	 ...
	 *             if expression is <code>false</code>
	 */
	public static void isTrue(boolean expression) throws Exception {
	...
	public static void notNullArray(Object[] array, String message) throws Exception {
	 ...
	 */
	public static void hasText(String text, String message) throws Exception {
	 ...
	 * @see StringUtils#hasText
	 */
	public static void hasText(String text) throws Exception {
	 ...
	 */
	public static void noNullElements(Object[] array, String message) throws Exception {
		if (array != null) {
	 ...
	 *             if the object array contains a <code>null</code> element
	 */
	public static void noNullElements(Object[] array) throws Exception {
	 ...
	 *             if the collection is <code>null</code> or has no elements
	 */
	public static void notEmpty(Collection collection) throws Exception {
	 ...
	 *             if the map is <code>null</code> or has no entries
	 */
	public static void notEmpty(Map map) throws Exception {
	 ...
	 */
	public static void isInstanceOf(Class clazz, Object obj) throws Exception {
	 ...
	 * @see Class#isInstance
	 */
	public static void isInstanceOf(Class type, Object obj, String message) throws Exception {
		notNull(type, "Type to check against must not be null");
		if (!type.isInstance(obj)) {
			throw new Exception(message + "Object of class [" + (obj != null ? obj.getClass().getName() : "null") + "] must be an instance of " + type);
		}
	}
	 ...
	 */
	public static void isAssignable(Class superType, Class subType) throws Exception {
	 ...
	 *             if the classes are not assignable
	 */
	public static void isAssignable(Class superType, Class subType, String message) throws Exception {
		notNull(superType, "Type to check against must not be null");
		if (subType == null || !superType.isAssignableFrom(subType)) {
			throw new Exception(message + subType + " is not assignable to " + superType);
		}
	}

	/**
	 * Assert a boolean expression, throwing <code>Exception</code>
	 * if the test result is <code>false</code>. Call isTrue if you wish to
	 * throw Exception on an assertion failure.
	 * 
	 * <pre class="code">
	 ...
	 *             if expression is <code>false</code>
	 */
	public static void state(boolean expression, String message) throws Exception {
		if (!expression) {
			throw new Exception(message);
		}
	}
	...
	/**
	 * Assert a boolean expression, throwing {@link Exception} if
	 * the test result is <code>false</code>.
	 * <p>
	 * Call {@link #isTrue(boolean)} if you wish to throw
	 * {@link Exception} on an assertion failure.
	 * 
	 * <pre class="code">
	 ...
	 */
	public static void state(boolean expression) throws Exception {
