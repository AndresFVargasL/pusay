...
public class NumberUtils {
	...
	/**
	 * Convertimos el numero double a String, agregando formato para que sea procesado El numero de decimales esta
	 * determinado por %.2f ej. %10.2f (10 posiciones enteras y 2 decimales) si no se pone el primer valor por default
	...
	public static Double getRoundDouble(Double number) {
		if (number == null) {
			throw new NumberFormatException("El n�mero a convertir en obligatorio");
		}
