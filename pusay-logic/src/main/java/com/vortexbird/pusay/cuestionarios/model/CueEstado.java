...
public class CueEstado implements java.io.Serializable {
	...
	public CueEstado(Long consecutivo, String nombre, Long estado) {
		this.consecutivo = consecutivo;
		this.nombre = nombre;
		this.estado = estado;
	}

	public CueEstado(Long consecutivo, String nombre, String descripcion,
			Long estado, Set<CueCuestionario> cueCuestionarios) {
		this.consecutivo = consecutivo;
		this.nombre = nombre;
